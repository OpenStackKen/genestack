---
title: "2024.1 (Caracal) to 2025.1 (Epoxy)"
description: "Upgrading Genestack from OpenStack 2024.1 (Caracal) to OpenStack 2025.1 (Epoxy)"
weight: 20
---
This guide outlines the process for upgrading a Genestack deployment from [OpenStack 2024.1 (Caracal)](https://docs.openstack.org/2024.1/) to [OpenStack 2025.1 (Epoxy)](https://docs.openstack.org/2025.1/). Genestack leverages OpenStack-Helm charts for deployment and management, making upgrades primarily a matter of updating the underlying charts and configurations via Git and Helm.
