---
title: "MariaDB"
description: "Tips and tricks for managing and operating the MariaDB cluster within a Genestack environment."
weight: 30
---

Running MariaDB in Genestack requires careful attention to detail for optimal performance and reliability.
...
```bash {include="scripts/backup-mariadb.sh"}
```
