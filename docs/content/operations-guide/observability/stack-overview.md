---
title: "Monitoring and Observability Stack Overview"
weight: 235
---
...
- [Getting Started](/deployment-guide/open-infrastructure/observability/getting-started/) for install order and day-one validation
- [Prometheus](/deployment-guide/open-infrastructure/observability/prometheus/) for metrics storage and alerting
...
- [OpenTelemetry](/deployment-guide/open-infrastructure/observability/opentelemetry/) for collectors and infrastructure telemetry receivers
...
- [OpenTelemetry Metrics Reference](/operations-guide/observability/otel-base-metrics/)
