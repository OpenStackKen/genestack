---
title: "Keystone Federation to Rackspace"
...
> [!NOTE] Example keystone `mapping.json` file
>
>
> ```json {include="etc/keystone/mapping.json"}
> ```
>
...
> [!IMPORTANT] shibboleth2.xml file
>
>
...
> [!IMPORTANT] Example `attribute-map.xml` configurations
>
>
> ### Auth-0
>
...
> [!NOTE] Example keystone `saml-mapping.json` file
>
>
> ### Rackspace
>
...
> [!IMPORTANT] keystone-helm-overrides.yaml
>
>
...
> [!IMPORTANT] Using the API with WebSSO and Federation
>
>
