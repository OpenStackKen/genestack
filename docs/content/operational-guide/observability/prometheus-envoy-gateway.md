...
Following the deployment of the [Envoy Gateway](/deployment-guide/open-infrastructure/infrastructure/envoy-gateway-api/) the metrics will be served and the service monitor will be created.
