...
flowchart TB
    ...
    subgraph GENESTACK[ "" ]
        ...
        subgraph HEADER[ "" ]
            direction TB
            ICON("<img src='/assets/svg/Logo-Color.svg'; width='200'; max-width: '100%'; />")
            TITLE( Genestack )
        end
        subgraph ROW1[ "" ]
            direction TB
            subgraph ITEM11[ "" ]
                direction RL
                ITEM11ICON("<img src='/assets/svg/Forecast.svg'; width='80' />")
                ITEM11LABEL[ <font color=#e03132>Forecast ]
            end
            subgraph ITEM12[ "" ]
                direction RL
                ITEM12ICON("<img src='/assets/svg/Learning.svg'; width='80' />")
                ITEM12LABEL[ <font color=#e03132>Learning ]
            end
            subgraph ITEM13[ "" ]
                direction RL
                ITEM13ICON("<img src='/assets/svg/Customization.svg'; width='80' />")
                ITEM13LABEL[ <font color=#e03132>Customization ]
            end
            subgraph ITEM14[ "" ]
                direction RL
                ITEM14ICON("<img src='/assets/svg/Support.svg'; width='80' />")
        ...
        subgraph ROW2[ "" ]
            ...
            subgraph ITEM21[ "" ]
                direction RL
                ITEM21ICON("<img src='/assets/svg/Firewall.svg'; width='80' />")
                ITEM21LABEL[ <font color=#e03132>Firewall ]
            end
            subgraph ITEM22[ "" ]
                direction RL
                ITEM22ICON("<img src='/assets/svg/Security.svg'; width='80' />")
                ITEM22LABEL[ <font color=#e03132>Security ]
            end
            subgraph ITEM23[ "" ]
                direction RL
                ITEM23ICON("<img src='/assets/svg/RBAC.svg'; width='80' />")
                ITEM23LABEL[ <font color=#e03132>RBAC ]
            end
            subgraph ITEM24[ "" ]
                direction RL
                ITEM24ICON("<img src='/assets/svg/Artifact.svg'; width='80' />")
        ...
        subgraph ROW3[ "" ]
            ...
            subgraph ITEM31[ "" ]
                direction RL
                ITEM31ICON("<img src='/assets/svg/Alerting.svg'; width='80' />")
                ITEM31LABEL[ <font color=#e03132>Alerting ]
            end
            subgraph ITEM32[ "" ]
                direction RL
                ITEM32ICON("<img src='/assets/svg/Dashboard.svg'; width='80' />")
                ITEM32LABEL[ <font color=#e03132>Dashboard ]
            end
            subgraph ITEM33[ "" ]
                direction RL
                ITEM33ICON("<img src='/assets/svg/Logs.svg'; width='80' />")
                ITEM33LABEL[ <font color=#e03132>Logs ]
            end
            subgraph ITEM34[ "" ]
                direction RL
                ITEM34ICON("<img src='/assets/svg/Automation.svg'; width='80' />")
