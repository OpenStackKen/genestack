...
weight: 10
---
Genestack utilizes Prometheus for monitoring, alerting and metrics collection. To read more about Prometheus [Prometheus](/deployment-guide/open-infrastructure/observability/prometheus/)
...
To get started using monitoring within the Genestack ecosystem begin with the [getting started](/deployment-guide/open-infrastructure/observability/getting-started/) page.
