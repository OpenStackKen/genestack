...
description: "Deploying the Designate services."
weight: 20
---
...
Run the Designate deployment Script `/opt/genestack/bin/install-designate.sh`

```bash {include="bin/install-designate.sh"}
```
> [!TIP]
>
