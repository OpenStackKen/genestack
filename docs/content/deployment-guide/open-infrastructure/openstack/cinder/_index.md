...
>
> If Cinder will be deployed with an external Ceph storage backend, review the [OpenStack Cinder Ceph Store](/operations-guide/openstack/cinder/cinder-ceph-store/) operator documentation for additional steps and setup.
>
