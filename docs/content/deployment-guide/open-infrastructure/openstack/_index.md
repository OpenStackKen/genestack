...
> [!NOTE]
>
> From this point forward we're building our OpenStack cloud. The following service deployments will leverage `helm` as the package manager and `kustomize` as our configuration management backend.
