...
> [!genestack]
>
> To deploy Barbican, run the Barbican deployment script `/opt/genestack/bin/install-barbican.sh`.

```bash {include="bin/install-barbican.sh"}
```
