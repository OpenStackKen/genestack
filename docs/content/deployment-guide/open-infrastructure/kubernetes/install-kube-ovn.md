...
> [!IMPORTANT] Example Kube-OVN Helm Overrides
>
>
...
> [!IMPORTANT] Label all controllers as Kube-OVN control plane nodes
>
>
> ```shell
...
> [!IMPORTANT] Run the Kube-OVN deployment Script `/opt/genestack/bin/install-kube-ovn.sh`
>
>
> ```shell {include="bin/install-kube-ovn.sh"}
> ```
>
