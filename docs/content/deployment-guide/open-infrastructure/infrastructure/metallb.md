...
> [!IMPORTANT] Run the MetalLB deployment Script `/opt/genestack/bin/install-metallb.sh` You can include paramaters to deploy aio or base-monitoring. No paramaters deploys base
>
>
> ```shell {include="bin/install-metallb.sh"}
> ```
>
## Example LB manifest

> [!NOTE] Example for `metallb-openstack-service-lb.yml` file.
>
>
