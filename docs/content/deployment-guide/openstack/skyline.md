...
weight: 650
aliases:
  - /deployment-guide/openstack-skyline/
  - /openstack-skyline/
---
...
>
>
> Pause for a moment to consider if you will be wanting to access Skyline via the gateway-api controller over a specific FQDN. If so, adjust the gateway api definitions to suit your needs. For more information view [Gateway API](/deployment-guide/infrastructure-gateway-api/)...
>
