...
See the [Prometheus installation guide](/deployment-guide/prometheus/) for detailed setup instructions.
...
For more information about Grafana's capabilities, visit the [Grafana](/deployment-guide/grafana/).
...
- [Slack Alerts](/deployment-guide/alertmanager-slack/) - Send alerts to Slack channels
- Email notifications
...
These operator-managed rules are curated for best practices and don't require manual configuration. For service-specific monitoring details, refer to the individual service documentation. For example: [RabbitMQ Operator Monitoring](/deployment-guide/infrastructure-rabbitmq/#rabbitmq-operator-monitoring).
