...
Ensure you have followed the instructions in [OpenStack Getting Started with CLI](/cloud-onboarding/openstack-getting-started-cli/) and ensure that you can authenticate.
