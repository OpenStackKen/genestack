...
View the [memcached exporter](/deployment-guide/prometheus-memcached-exporter/) instructions to install a HA ready memcached cluster with monitoring and metric collection enabled.
...
>
>
> For more information on how to enable memcached monitoring with prometheus, see the [memcached exporter](/deployment-guide/prometheus-monitoring-overview/) documentation.
